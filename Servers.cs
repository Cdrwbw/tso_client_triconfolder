    ...
    class Servers
    {
        ...
        public static Dictionary<string, Dictionary<string, string>> trans = new Dictionary<string, Dictionary<string, string>>()
        {
            { "ru-ru", new Dictionary<string, string>() {
                ...
                { "exit", "закрыть" },
                { "remember", "Запомнить" },
                { "del_tsoportable","Удалить каталог tso_portable?" },
                { "opentsoportable","Откройте каталог tso_portable" },
                { "deltsoportable","Удалите каталог tso_portable" },
             }
            },
            { "en-uk", new Dictionary<string, string>() {
                ...
                { "exit", "exit" },
                { "remember", "Remember" },
                { "del_tsoportable","Delete tso_portable folder?"},
                { "opentsoportable","Open the tso_portable directory" },
                { "deltsoportable","Delete the tso_portable directory" },
             }
            },
            { "fr-fr", new Dictionary<string, string>() {
                ...
                { "exit", "fermer" },
                { "remember", "Retenir" },
                { "del_tsoportable","Supprimer le répertoire tso_portable ?" },
                { "opentsoportable","ouvrir le répertoire tso_portable" },
                { "deltsoportable","Supprimer le répertoire tso_portable" },
              }
           },
           { "pl-pl", new Dictionary<string, string>() {
                ...
                { "exit", "Wyjście" },
                { "remember", "Zapamiętaj" },
                { "del_tsoportable","Usunąć katalog tso_portable?" },
                { "opentsoportable","Otwórz katalog tso_portable" },
                { "deltsoportable","Usuń katalog tso_portable" },
             }
           },
           { "de-de", new Dictionary<string, string>() {
                ...
                { "exit", "schließen" },
                { "remember", "Erinnern" },
                { "del_tsoportable","Das Verzeichnis tso_portable löschen?" },
                { "opentsoportable","Verzeichnis tso_portable öffnen" },
                { "deltsoportable","Löschen Sie das Verzeichnis tso_portable" },
              }
           },
           { "pt-br", new Dictionary<string, string>() {
                ...
                { "exit", "sair" },
                { "remember", "Lembrar" },
                { "del_tsoportable","Eliminar o directório tso_portable ?" },
                { "opentsoportable","Abrir o directório tso_portable" },
                { "deltsoportable","Apagar o directório tso_portable" },
              }
           }
        };
